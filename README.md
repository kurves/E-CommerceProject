...
## 📌 Project Overview
This project analyzes transactional and web data for an e-commerce business to
identify revenue drivers, funnel drop-offs, customer retention patterns, and
refund risks.
